  ...
  return (
    <div className="insurance-form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="duration">Durée de l'Assurance:</label>
          <select
            id="duration"
            name="duration"
        ...
        <div className="form-group">
          ...
          <select
            ...
            required
          >
            <option value="">Sélectionner le type de couverture</option>
...
export default CommandeAssurance;
